  /**
       * In this Test Case we will test the Contact Us Form 
       */

describe("Go to the Homepage ", function(){
 browser.ignoreSynchronization=true; // This will let protractor know the website is not angular
   it("Go to the Home page ", function(){
    browser.get("http://artsyjewels.com/");
